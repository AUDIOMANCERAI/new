...
import { LayoutGrid, Music, Settings, Mic2, Disc3, LogOut, Cpu, Activity } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-screen bg-mpc-bg text-white overflow-hidden font-sans">
      ...
      {/* Sidebar Navigation */}
      <aside className="w-64 bg-mpc-panel border-r-2 border-gray-800 flex flex-col shadow-[0_0_30px_rgba(0,0,0,0.5)] z-50">
        {/* Branding */}
        <div className="h-20 flex items-center px-6 border-b-2 border-gray-800 bg-[#050505] relative overflow-hidden">
        ...
        <div className="p-6 border-b-2 border-gray-800">
           <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded bg-gradient-to-br from-mpc-primary to-mpc-secondary flex items-center justify-center font-bold text-black border-2 border-white">
                 A
              </div>
              <div>
           ...
           {navItems.map((item) => (
             <button
                ...
                className={`
                  ...
                  ${activeTab === item.id 
                    ? 'bg-white/5 border-mpc-primary text-white shadow-[inset_0_0_10px_rgba(0,243,255,0.1)]' 
        ...
        {/* Footer */}
        <div className="p-4 border-t-2 border-gray-800 bg-[#050505]">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col relative overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900 via-[#050505] to-black">
        
        {/* Header */}
        <header className="h-16 border-b-2 border-gray-800 bg-mpc-panel/50 backdrop-blur-md flex items-center justify-between px-8 z-40">
           <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 bg-mpc-success rounded-full shadow-[0_0_5px_currentColor]"></div>
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar relative">
           ...
           {activeTab !== 'mpc' && ActiveIcon && (
             <div className="flex flex-col items-center justify-center h-full text-center opacity-50">
                <ActiveIcon size={64} className="text-gray-700 mb-4" />
